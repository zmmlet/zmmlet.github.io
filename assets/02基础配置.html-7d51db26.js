import{_ as n,Q as s,S as a,a2 as e}from"./framework-2a383c78.js";const p={},t=e(`<h1 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>在 <code>docs\\.vuepress</code> 文件下新建 <code>config.js</code> 文件，基础配置所有配置项在 <code>config.js</code> 文件中进行配置</p></div><h2 id="配置项目名称-项目描述" tabindex="-1"><a class="header-anchor" href="#配置项目名称-项目描述" aria-hidden="true">#</a> 配置项目名称，项目描述</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
