import{_ as e,Q as t,S as o,Z as n,$ as s,a1 as p,a2 as l,E as i}from"./framework-2a383c78.js";const c={},r=n("h1",{id:"vite-项目初始化配-vue3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite-项目初始化配-vue3","aria-hidden":"true"},"#"),s(" Vite 项目初始化配(Vue3)")],-1),u=n("h2",{id:"使用包管理工具-pnpm-进行依赖管理",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用包管理工具-pnpm-进行依赖管理","aria-hidden":"true"},"#"),s(" 使用包管理工具 pnpm 进行依赖管理")],-1),d={href:"https://www.pnpm.cn/installation",target:"_blank",rel:"noopener noreferrer"},k=l(`<ul><li>包安装速度极快（不会重复安装，重复包 pnpm 会使用直接使用 hard link 去.pnpm-store 找对应版本的包，直接写入到项目的 package.json 文件中）</li><li>磁盘空间利用效率高（体现在公共仓库.pnpm-store）</li></ul><h2 id="配置按需加载-ant-design-vue-ui-组件" tabindex="-1"><a class="header-anchor" href="#配置按需加载-ant-design-vue-ui-组件" aria-hidden="true">#</a> 配置按需加载 ant Design Vue UI 组件</h2><ol><li>安装 <code>pnpm add unplugin-vue-components -D</code></li><li>在 vite.config.js 引入配置</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 引入 ant design vue 按需加载</span>
